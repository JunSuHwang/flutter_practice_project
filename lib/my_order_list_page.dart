...
import 'package:flutter_practice_project/enum/delivery_status.dart';
import 'package:flutter_practice_project/enum/payment_status.dart';
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            return ListView(
              ...
              //! 제품 상세 정보를 가져오기 위해 제품 번호를 기준으로 쿼리해서 가져와야 합니다.
              final productDetailRef = FirebaseFirestore.instance
                  .collection("products")
                  .withConverter(
                      fromFirestore: (snapshot, _) =>
              ...
              return StreamBuilder(
                  stream: productDetailRef.snapshots(),
